...
# [klp] {
parser.add_argument(
    "--tag_width", type=int, default=4, help="The width of the key."
)
parser.add_argument(
    "--tag_pos",
    type=int,
...
# )
cache_hierarchy = NoPrefetchKLPP1P2S3CacheHierarchy(
    l1i_size="32KiB",
    l1i_assoc=8,
    l1d_size="32KiB",
    l1d_assoc=8,
...
processor = SimpleProcessor(
    cpu_type=selected_cpu_type, isa=ISA.RISCV, num_cores=1  # O3, ATOMIC
)
...
if args.save_cpt:
    print(
        f"Reached target inst number or exit event. Saving checkpoint to {args.save_cpt}..."
    )
